...
pub fn get_post_window(slug: Option<String>) -> WindowProps {
    WindowProps {
...
pub fn get_history_window() -> WindowProps {
    WindowProps {
...
pub fn get_best_window() -> WindowProps {
    WindowProps {
...
pub fn get_random_window() -> WindowProps {
    WindowProps {
